...
class Position {
  final String col;  // Corresponds to columns (a to h, where column a is the first column on the board)
  final int row;  // Corresponds to rows (1 to 8, where row 1 is the 1st row on the board)
